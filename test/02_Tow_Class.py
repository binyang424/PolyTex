...
# surf_points = pk.pk_load("./pcd/binder_4.pcd").to_numpy()
#
# #####################################################################
...
mesh = tow.surf_mesh(plot=True, save_path="./stl/binder_4.ply", end_closed=True)

trajectory_sm = tow.trajectory(smooth=0.0015, plot=False,
                               save_path="./trajectory.ply", orientation=True)
