...
def addPoints(coordinate, threshold = 0.03):
    ...
    for iDelta in np.arange(deltaD.size):
        if deltaD[iDelta] < threshold:
            ...
            dtemp = np.linspace(coordinate[iDelta, 0], coordinate[iDelta +1, 0], int(deltaD[iDelta]/0.05)+1, endpoint=True)
...
if __name__ == "__main__":
    ...
    yinter = curve1Dinter(dataset, "const", "cub", nuggetEffect=0, inter = ' ')
