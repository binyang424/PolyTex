Welcome to PolyKriging's documentation!
=======================================
...
For more details, please visit https://binyang.fun/pk. Everything is
...
https://github.com/binyang424/polykriging/issues. Please report any bugs
that you find. Or, even better, fork the repository on GitHub and create
a pull request. We welcome all changes, big or small, and we will help
you make the pull request if you are new to git (email to:
bin.yang@polymtl.ca).
